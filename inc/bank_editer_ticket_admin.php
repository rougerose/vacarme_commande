 ...
 * @return <type>
 */
function inc_bank_editer_ticket_admin($id_transaction){
	...
	$res = sql_select("*","spip_commandes_transactions","id_transaction=".intval($id_transaction));
	...
	$envoyer_mail($email,$sujet,$ticket,'reglements@rouge-rose.net',$header);
}
